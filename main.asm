...
length2Char_char: .asciiz "T"
length2Char_CSisFun: .asciiz "I'll be back!"

# strcmp
strcmp_header: .asciiz "\n\n********* strcmp *********\n"
strcmp_str1: .asciiz "MIPS!! Hi"
strcmp_str2: .asciiz "MIPS.. Hi"

# toMorse
toMorse_header: .asciiz "\n\n********* toMorse *********\n"
toMorse_plaintext: .asciiz "MIPS!!"
toMorse_mcmsg: .space 35
.align 2
toMorse_size: .word 35
